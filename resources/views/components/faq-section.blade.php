<section id="faq" class="relative z-10 py-32 px-6 border-t border-[#0d1b4b]/8 bg-white/30 backdrop-blur-sm">
            ...
            @foreach ($items as $index => $item)
                @php
                    $colors = [
                        ...
                        'indigo' => 'hover:border-[#0d1b4b]/30 text-[#0d1b4b]/70',
                        'purple' => 'hover:border-[#a07c1e]/35 text-[#a07c1e]',
                ...
                <div class="group rounded-2xl bg-white/70 backdrop-blur-xl border border-[#0d1b4b]/10 {{ explode(' ', $color)[0] }} transition-all duration-300 overflow-hidden">
                    ...
                    <button
                        ...
                        <span class="text-[#0d1b4b] font-bold text-lg">
                            {{ $item['question'] }}
                        </span>

                        <svg
                            :class="active === {{ $index }} ? 'rotate-180 {{ explode(' ', $color)[1] }}' : 'text-[#0d1b4b]/35'"
                    ...
                    <div
                        x-show="active === {{ $index }}"
                        x-transition
                        class="px-6 pb-6 text-[#0d1b4b]/65 leading-relaxed">
