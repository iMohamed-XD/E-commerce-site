    ...
    <div class="bg-white/70 backdrop-blur-xl border border-[#0d1b4b]/10 rounded-3xl shadow-xl shadow-[#0d1b4b]/6 px-8 py-10">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div class="pt-2">
                <button
                    type="submit"
                    class="group relative w-full py-3.5 px-6 bg-[#d4af37] text-[#0d1b4b] text-base font-black rounded-2xl hover:bg-[#c5a02e] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-[#d4af37]/25 overflow-hidden"
                >
            ...
            <a href="{{ route('login') }}"
                class="block w-full text-center py-3.5 rounded-2xl border border-[#0d1b4b]/12 text-[#0d1b4b]/60 text-sm font-bold hover:border-[#0d1b4b]/25 hover:text-[#0d1b4b] hover:bg-[#0d1b4b]/3 transition-all duration-200">
