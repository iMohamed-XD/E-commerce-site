<x-guest-layout>
    <div class="bg-white/70 backdrop-blur-xl border border-[#0d1b4b]/10 rounded-3xl shadow-xl shadow-[#0d1b4b]/6 px-8 py-10 space-y-6">
        <div class="text-center">
            <h1 class="text-2xl font-black text-[#0d1b4b]">{{ __('نسيت كلمة المرور') }}</h1>
            <p class="mt-2 text-sm text-[#0d1b4b]/50">
                {{ __('لا تقلق. أدخل بريدك الإلكتروني وسنرسل لك رابطًا لإعادة تعيين كلمة المرور واختيار كلمة مرور جديدة.') }}
            </p>
        </div>
